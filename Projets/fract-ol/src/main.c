...
/*   Updated: 2024/02/19 23:52:46 by tlebon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../fractol.h"

// void	free_all(t_mlx_data *s_mlx)
// {
// 	ft_putstr("C'est pas free boufon !\n");
// }
...
// int	key_hook(int keycode, t_mlx_data *s_mlx)
// {
// 	if (keycode == 27)
// 	{
...
int	main(int ac, char *av[])
{
	...
	else if (ac > 1 && av[1][0] == 'j')
	{
		if (ac < 3 || !ft_isdigit(ft_atoi(av[2])))
		{
		ft_putstr("\033[1;31mNot enough arguments\n\033[0mThe \033[1;32mcorrect\033[0m use is:\n./fractol m\n./fractol j <number>\n");
		return (1);
		}
		ft_putstr("Ensemble de Julia selectionne\n");
	}
	...
	if (!s_mlx.win)
		return (1);
	// mlx_hook(s_mlx.win, 2, 1L << 0, keyhook(), &s_mlx);
